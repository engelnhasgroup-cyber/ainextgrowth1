          ...
          {categories.map((cat, i) => {
            ...
            return (
              <motion.button
                ...
                className="group relative flex flex-col gap-3 overflow-hidden rounded-2xl border border-border/60 bg-card/50 p-4 text-left card-hover hover:border-primary/40"
              >
